...
class UserChallengesModel extends BaseModel {
    constructor() {
        ...
        this.filterMapping = {
            user_id: 'user_challenges.user_id',
            challenge_id: 'user_challenges.challenge_id',
            status: 'user_challenges.status',
        };
    }
}

export default new UserChallengesModel();
