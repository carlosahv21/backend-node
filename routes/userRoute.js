...
router.get("/",
    ...
    authMiddleware.authorize("settings.users", "view"),
...
router.post("/",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("settings.users", "create"),
...
router.put("/:id",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("settings.users", "edit"),
...
router.delete("/:id",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("settings.users", "delete"),
