...
router.get("/",
    ...
    authMiddleware.authorize("modules", "view"),
...
router.post("/",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("modules", "create"),
...
router.put("/:id",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("modules", "edit"),
...
router.delete("/:id",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("modules", "delete"),
