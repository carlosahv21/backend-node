...
router.get("/",
    ...
    authMiddleware.authorize("settings.customFields", "view"),
...
router.post("/",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("settings.customFields", "create"),
...
router.put("/:id",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("settings.customFields", "edit"),
...
router.delete("/:id",
    authMiddleware.authenticateToken,
    authMiddleware.authorize("settings.customFields", "delete"),
